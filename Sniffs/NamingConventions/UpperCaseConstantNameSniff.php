...
/**
 * Symfony2_NamingConventions_UpperCaseConstantNameSniff
 *
 ...
 */
class Symfony2_Sniffs_NamingConventions_UpperCaseConstantNameSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$openBracket]['code'] !== T_OPEN_PARENTHESIS) {
            ...
            // This is a real constant, in use from a foreign target
            /*
            if (strtoupper($constName) !== $constName) {
